...
class ICustomerRepositoryImplTest {
	...
	void tearDown() throws Exception {
	  ...
	  Customer c1 =new Customer(2,"Vandu",9810830597l,"neha@gmail.com","Laxminagar","Neha_Saxena","12345678"); 
	  Customer c2=new Customer(2,"Vandu",9810830597l,"neha@gmail.com","Laxminagar","Neha_Saxena","12345678"); 
	  repo.addCustomer(c1);
	  
	  assertEquals(c1.getCustomerName(),c2.getCustomerName(),()->"Object should return the same name");
	  ...
	  assertNull(customerdeleted);
		  ...
		  @Test 
		  void SpecificCustomer() throws CustomerIdNotFoundException { int id=2;
		  Customer c1=new Customer(); 
		  c1=repo.viewCustomer(id);
		  ...
		  @Test void AllCustomer() { 
		  Customer c1=new Customer(3,"Nikhil",123456789l,"nikhil@gmail.com","Khan Market","Nikhil_1234","1234567890"); 
		  Customer c2=new Customer(4,"Sanjay",987456321l,"sanjay@gmail.com","RK Puram","Sanjay_1234","1284539"); 
		  Customer c3=new Customer(5,"amandeep",587469321l,"amandeep@gmail.com","PatelNagar","amandeep_1234","25874685");
